...
def classify_digit(image):
    # this function trains a classifier on sklearn digits dataset, and then trains a support vector machine
    # once trained, it will classify the input 'image' and returns the predicted digit
...
while True:
    ...
    print("Client-message Sent processed image reply %s " % index)
    index += 1
